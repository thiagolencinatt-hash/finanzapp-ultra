...
* **Fecha**: 2026-09-22
* **SÌntomas**: Usuarios hacÌan click en 'Empezar de cero' por error al intentar exportar, el modal del IA Assistant permitÌa interactuar con el fondo por mala gestiÛn del backdrop, y los saldos parpadeaban.
* **Causa RaÌz**: ColocaciÛn riesgosa de botones de destrucciÛn masiva junto a opciones comunes; falta de backdrop opaco bloqueante; coexistencia hÌbrida de localStore (fallback) para usuarios autenticados que enmascaraba datos de Supabase tras timeouts.
* **SoluciÛn**: Removido botÛn de reset de ·reas comunes de navegaciÛn; modal IA 100% opaco y sin scroll document.body; eliminados los fallbacks a localStore si el usuario no es DEMO, forzando la consistencia transaccional (SSoT) en Supabase.
* **Regla Preventiva**: (1) JAM¡S ubicar acciones destructivas junto a acciones de lectura/exportaciÛn. (2) Si el usuario est· autenticado en la nube, NO hacer fallback de lectura en localStore a menos que haya un modo offline explÌcito.
